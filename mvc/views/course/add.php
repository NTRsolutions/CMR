                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        <label for="status" class="col-sm-2 control-label">
                            <?=$this->lang->line("course_status")?>
                        </label>
                        <div class="col-sm-6">
                            <?php 
                                echo form_dropdown("status", array($this->lang->line('course_status_approved') => $this->lang->line('course_status_approved'), $this->lang->line('teacher_status_pending') => $this->lang->line('course_status_pending')), set_value("status"), "id='status' class='form-control'"); 
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
