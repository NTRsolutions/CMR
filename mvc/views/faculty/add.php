...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_faculty')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                ...
                <form class="form-horizontal" role="form" method="post">
                   ...
                   <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="faculty" name="code" value="<?=set_value('code')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_faculty")?>" >
                        </div>
                    </div>
